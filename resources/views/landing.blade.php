    ...
    <section class="cs-bg" data-src="landingpage/assets/img/feature_bg.svg" id="pricing">
        ...
        <div class="container">
            ...
            <div class="cs-seciton_heading cs-style1 text-center">
                ...
                <div class="cs-height_10 cs-height_lg_10"></div>
                <h3 class="cs-section_title">Paket Layanan</h3>
            </div>
            <div class="cs-height_50 cs-height_lg_40"></div>
            <div class="row">
                        ...
                        <div class="cs-pricing_table cs-style1">
                            <div class="cs-pricing_head">
                                <div class="cs-pricing_heading">
                                    ...
                                    <h2 class="cs-pricing_title cs-m0">{{ $product->name }}</h2>
                                </div>
                                @if ($product->price != 0)
                                    <div class="cs-price cs-primary_font">
                                        <b class="cs-accent_color">@currency($product->price)</b>
                                    </div>
                                    <span>/bulan</span>
                                @else
                                    <div class="cs-price cs-primary_font">
                                        <b class="cs-accent_color">FREE</b>
                                    </div>
                                @endif
                            </div>
    ...
    <section class="cs-gradient_bg_1" id="news">
        ...
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                ...
                <div class="cs-height_10 cs-height_lg_10"></div>
                <h3 class="cs-section_title">Dapatkan Informasi Terkini</h3>
            </div>
            <div class="cs-height_50 cs-height_lg_40"></div>
                                ...
                                <div class="cs-post cs-style1">
                                    <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                                        <div class="cs-post_thumb_in cs-bg"
                                            data-src="landingpage/assets/img/post_1.jpeg">
                                        </div>
                                    </div>
