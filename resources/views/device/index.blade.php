                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, row, meta) {
                            ...
                            if (row.status == 'unauthenticated') {
                                actions +=
                                    `<a href="#" data-block="body" data-url="{{ $url }}/${row.session_key}" class="ajax_modal btn btn-xs btn-info tooltips text-light" data-placement="left" data-original-title="View QR" ><i class="fa fa-qrcode"></i></a> `;
                            }
